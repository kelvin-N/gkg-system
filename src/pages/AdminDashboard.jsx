        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button onClick={handleLogout} className="btn-secondary inline-flex items-center justify-center">
            <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 00-3-3h4a3 3 0 013 3v1" />
            </svg>
            Logout
          </button>
      ...
      <section className="card">
        ...
        {loading ? (
          ...
          <div className="rounded-xl border border-dashed border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 p-10 text-center text-gray-500 dark:text-gray-400">
            {bookings.length === 0 ? "No bookings yet. New appointment requests will appear here as they come in." : "No bookings match your current filters."}
          </div>
        ) : (
